...
public class Bike extends AbstractManufacturer implements Vehicle {
	public Bike(String name, String modelName, String bikeType) {
		...
		super.setType(bikeType);
	}

	/*
	 * Method returns maximum speed depending upon their types For Sports-300kmh For
	 * cruiser-170kmh
	 */
	@Override
	...
	public String getManufacturerInformation() {
		return "Bike{Manufacturer name:" + super.getName() + "," + "Model Name:" + super.getModelName() + "," + "Type:"
				+ super.getType() + "}";
	}
}
